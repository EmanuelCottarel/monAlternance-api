 ...
 */
final class Version20230523122351 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE application ADD user_id INT NOT NULL, ADD status VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE application DROP user_id, DROP status');
    }
}
